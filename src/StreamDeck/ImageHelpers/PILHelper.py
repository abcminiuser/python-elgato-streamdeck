...
def create_image(deck: StreamDeck, background: str = 'black') -> Image:
    """
    .. deprecated:: 0.9.5
...
def create_key_image(deck: StreamDeck, background: str = 'black') -> Image:
    """
...
def create_touchscreen_image(deck: StreamDeck, background: str = 'black') -> Image:
    """
    Creates a new PIL Image with the correct image dimensions for the given
...
def create_screen_image(deck: StreamDeck, background: str = 'black') -> Image:
    """
    Creates a new PIL Image with the correct image dimensions for the given
...
def create_scaled_image(deck: StreamDeck, image: Image, margins: tuple[int, int, int, int] = [0, 0, 0, 0], background: str = 'black') -> Image:
    """
    .. deprecated:: 0.9.5
...
def create_scaled_key_image(deck: StreamDeck, image: Image, margins: tuple[int, int, int, int] = [0, 0, 0, 0], background: str = 'black') -> Image:
    """
...
def create_scaled_touchscreen_image(deck: StreamDeck, image: Image, margins: tuple[int, int, int, int] = [0, 0, 0, 0], background: str = 'black') -> Image:
    """
...
def create_scaled_screen_image(deck: StreamDeck, image: Image, margins: tuple[int, int, int, int] = [0, 0, 0, 0], background: str = 'black') -> Image:
    """
...
def to_native_format(deck: StreamDeck, image: Image) -> bytes:
    """
    .. deprecated:: 0.9.5
...
def to_native_key_format(deck: StreamDeck, image: Image) -> bytes:
    """
...
def to_native_touchscreen_format(deck: StreamDeck, image: Image) -> bytes:
    """
...
def to_native_screen_format(deck: StreamDeck, image: Image) -> bytes:
    """
